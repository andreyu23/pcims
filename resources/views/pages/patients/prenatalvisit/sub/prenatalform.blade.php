<x-slot name="header">{{ __('Pre-natal Visits') }} </x-slot>
<x-slot name="subHeader">{{ __('You can submit a pre-natal form here.') }} </x-slot>
...
<div class="row mt-2 align-center">
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <input type="date" class="form-control" name="inp_dov" id="inp_date" placeholder="Enter date here..." required>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <select name="inp_fever" class="form-select js-select2" data-placeholder="Select Answer" required>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <select name="inp_vb" class="form-select js-select2" data-placeholder="Select Answer" required>
                    <option value="Select Answer" selected disabled> Select Answer </option>
                    <option value="Yes"> Yes </option>
                    <option value="No"> No </option>
                </select>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <select name="inp_pal" class="form-select js-select2" data-placeholder="Select Answer" required>
                    <option value="Select Answer" selected disabled> Select Answer </option>
                    <option value="Yes"> Yes </option>
                    <option value="No"> No </option>
                </select>
