...
<div class="row mt-2 align-center">
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <select name="inp_dose" class="form-select js-select2" data-placeholder="Select Dose" required>
    ...
    <div class="row mt-2 align-center">
        ...
        <div class="col-lg-7">
            <div class="form-control-wrap">
                <select name="inp_boost" class="form-select js-select2" data-placeholder="Select Booster" required>
