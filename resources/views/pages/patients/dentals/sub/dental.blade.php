...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-7">
        <div class="form-control-wrap">
            <select name="inp_check" class="form-select js-select2" data-placeholder="Select Answer" required>
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-7">
        <div class="form-control-wrap">
            <select name="inp_caries" class="form-select js-select2" data-placeholder="Select Answer" required>
                <option value="Select Answer" selected disabled> Select Answer </option>
                <option value="Yes"> Yes </option>
                <option value="No"> No </option>
            </select>
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-7">
        <div class="form-control-wrap">
            <select name="inp_mm" class="form-select js-select2" data-placeholder="Select Answer" required>
                <option value="Select Answer" selected disabled> Select Answer </option>
                <option value="Yes"> Yes </option>
                <option value="No"> No </option>
            </select>
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-7">
        <div class="form-control-wrap">
            <select name="inp_dof" class="form-select js-select2" data-placeholder="Select Days of Feeding" required>
